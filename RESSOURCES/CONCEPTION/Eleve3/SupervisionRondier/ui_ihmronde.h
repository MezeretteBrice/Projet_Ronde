...
public:
    ...
    void setupUi(QWidget *IHMRonde)
    {
        ...
        groupBoxFiltre = new QGroupBox(IHMRonde);
        ...
        verticalLayout_5->addWidget(groupBoxFiltre);

        //Modifications 2020
        horizontalLayout_5 = new QHBoxLayout(groupBoxFiltre);
        horizontalLayout_5->setSpacing(6);
        horizontalLayout_5->setObjectName(QStringLiteral("horizontalLayout_3"));
        horizontalLayout_5->setContentsMargins(30, 15, 30, 15);

        horizontalSpacer_7 = new QSpacerItem(40, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);
        horizontalLayout_5->addItem(horizontalSpacer_7);

        pushButtonAppliquerFiltres = new QPushButton(IHMRonde);
        pushButtonAppliquerFiltres->setObjectName(QStringLiteral("pushButtonAppliquerFiltres"));
        pushButtonAppliquerFiltres->setMinimumSize(QSize(100, 27));
        pushButtonAppliquerFiltres->setMaximumSize(QSize(100, 27));

        horizontalLayout_5->addWidget(pushButtonAppliquerFiltres);

        horizontalSpacer_8 = new QSpacerItem(40, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);
        horizontalLayout_5->addItem(horizontalSpacer_8);

        labelNumero = new QLabel(IHMRonde);
        labelNumero->setObjectName(QStringLiteral("labelBatiment"));
        labelNumero->setMinimumSize(QSize(100, 0));
        labelNumero->setMaximumSize(QSize(100, 16777215));

        horizontalLayout_5->addWidget(labelNumero);

        lineEditNumero = new QLineEdit(IHMRonde);
        lineEditNumero->setObjectName(QStringLiteral("lineEditBatiment"));
        lineEditNumero->setEnabled(false);

        horizontalLayout_5->addWidget(lineEditNumero);

        horizontalSpacer_9 = new QSpacerItem(40, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);
        horizontalLayout_5->addItem(horizontalSpacer_9);

        labelBatiment = new QLabel(IHMRonde);
        ...
        horizontalLayout_5->addWidget(labelBatiment);

        lineEditBatiment = new QLineEdit(IHMRonde);
        lineEditBatiment->setObjectName(QStringLiteral("lineEditBatiment"));
        lineEditBatiment->setEnabled(false);

        horizontalLayout_5->addWidget(lineEditBatiment);

        horizontalSpacer_10 = new QSpacerItem(40, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);
        horizontalLayout_5->addItem(horizontalSpacer_10);

        labelEtage = new QLabel(IHMRonde);
        ...
        horizontalLayout_5->addWidget(labelEtage);

        lineEditEtage = new QLineEdit(IHMRonde);
        lineEditEtage->setObjectName(QStringLiteral("lineEditBatiment"));
        lineEditEtage->setEnabled(false);

        horizontalLayout_5->addWidget(lineEditEtage);
    ...
    void retranslateUi(QWidget *IHMRonde)
    {
        ...
        pushButtonAppliquerFiltres->setText(QApplication::translate("IHMRonde", "Appliquer", 0));
        labelNumero->setText(QApplication::translate("IHMRonde", "Alias :", 0));
        labelBatiment->setText(QApplication::translate("IHMRonde", "Bâtiment :", 0));
        labelEtage->setText(QApplication::translate("IHMRonde", "Etage :", 0));
        //Fin
