...
public:
    ...
    void setupUi(QWidget *IHMPointeau)
    {
        ...
        lineEditEtage = new QLineEdit(IHMPointeau);
        lineEditEtage->setObjectName(QStringLiteral("lineEditEtage"));
        lineEditEtage->setEnabled(false);

        horizontalLayout_10->addWidget(lineEditEtage);
